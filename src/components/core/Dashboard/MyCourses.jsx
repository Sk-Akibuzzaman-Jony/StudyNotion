...
const MyCourses = () => {
  ...
  return (
    <div className="text-richblack-5">
      ...
      {courses.length > 0 ? (<table className="min-w-full bg-richblack-800 border border-richblack-500 rounded-xl">
                ...
                <td className="py-2 px-4">
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <div className="text-richblack-300 py-4">
                      ...
                      <div
                        className={`${
                          course.status === COURSE_STATUS.PUBLISHED
                            ...
                            : "text-red-300"
                        } bg-richblack-500 py-1 px-2 w-fit rounded-full flex gap-2 items-center`}
                      >
                        {course.status === COURSE_STATUS.PUBLISHED ? (
                          <FaCheckCircle />
                        ) : (
        ...
        </table>) : (<div> You haven't created any courses go to <Link to="/dashboard/add-course" className="text-blue-200 underline">Add Course</Link> to create one</div>)}  
      </div>
    </div>
  );
};
